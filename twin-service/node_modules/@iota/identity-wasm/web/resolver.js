...
import { Resolver as ResolverInner } from "./identity_wasm.js";
// `Resolver` type below acts the same as the "normal" resolver from `./identity_wasm.js`
 ...
 */
export class Resolver extends ResolverInner {
    /**
